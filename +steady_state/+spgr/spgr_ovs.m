function [M_ss, Mhst_] = spgr_ovs(spin, pulse, varargin)
  ...
  if isa(spin, 'mrphy.SpinCube')
    % SpinCube.pulse2beff injects loc_/b0Map_ from the object itself.
    kw = {  'b1Map',arg.b1Map, 'b1Map_',arg.b1Map_ ...
          , 'doEmbed',false};
  else
  ...
  beff_ = spin.pulse2beff(pulse, kw{:});
  [Mo_, Mhst_] = mrphy.sims.blochsim(spin.M_, beff_, spin.T1_, spin.T2_ ...
                                     , pulse.dt, spin.gam_ ...
                                     , arg.doCim);
